                                    ...
                                    {pedidos.map((pedido) => (
                                        <tr key={pedido.email}>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="flex items-center">
                                                    <div className="flex-shrink-0 h-10 w-10">
                                                        <img className="h-10 w-10 rounded-full" src={pedido.image} alt="" />
                                                    </div>
                                                    <div className="ml-4">
                                            ...
                                            <td className="px-6 py-4 text-center whitespace-nowrap">
                                                <div className="text-sm text-gray-900">{pedido.title}</div>
                                                <div className="text-sm text-gray-500">{pedido.department}</div>
                                            </td>
                                            <td className="px-6 py-4 text-center whitespace-nowrap">
                                                <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${pedido.status == 'concluído' ? 'bg-green-100 text-green-800' : pedido.status == 'em andamento' ? 'bg-yellow-100 text-yellow-900' : 'bg-red-100 text-red-900'}`}>
                                                    {pedido.status}
                                                </span>
                                            </td>
                                            <td className="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-500">{pedido.data}</td>
